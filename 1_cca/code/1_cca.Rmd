...
##################################################        
  ...
  ggsave(filename =  paste0(fl.output.supl_fig,"/Supplementary Figure Supl.fig before_after_combat_",Sys.Date(),".pdf")
         ,plot = q
         ,device = "pdf"
         ,width = 12
         ,height = 12)
  #####################
   ...
   write_csv(repl_fl_combat_ccadr_tpm
            ,paste0(fl.output,'/repl_fl_combat_ccadr_log2tpm_PB_',Sys.Date(),'.csv'))
```
...
################################################## 
  ...
  write_csv(median_log2tpm_combat
            ,paste0(fl.output,'/median_log2tpm_combat_PB_',Sys.Date(),'.csv'))
